...
// Marius Coetzee — 50-year-old white South African male. Override with ELEVENLABS_VOICE_ID.
const ELEVEN_VOICE = process.env.ELEVENLABS_VOICE_ID || 'n0ewC1nRdE3icIL01Xrs';
const ELEVEN_SPEED = parseFloat(process.env.ELEVENLABS_SPEED || '1.15');
            ...
            try {
                const r = await fetch('https://api.elevenlabs.io/v1/text-to-speech/' + voiceId + '?optimize_streaming_latency=2', {
                    ...
                    body: JSON.stringify({
                        ...
                        voice_settings: { stability: 0.55, similarity_boost: 0.85, style: 0.28, use_speaker_boost: true, speed: ELEVEN_SPEED },
                    }),
                });
